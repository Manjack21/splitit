...
<template>
    <div>
        ...
        <div class="w3-row w3-border-bottom">
            ...
            <div class="w3-col l4 s8 w3-center"><strong>Description</strong></div>
            <div class="w3-col l2 s3 w3-center"><strong>Amount</strong></div>
        </div>
        <div class="w3-row-padding w3-border-bottom" v-for="entry in entries" :key="entry.id">
            <div class="w3-col s1">
